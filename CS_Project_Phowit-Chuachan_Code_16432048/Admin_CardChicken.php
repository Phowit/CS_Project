<div class="container-fluid pt-4 px-4">
    <div class="row" style="margin: 7px;">
        <div class="col-sm-10 col-xl-10">
            <h5 style="margin-top: 5px;">ข้อมูลการนำไก่เข้าโรงเรือน</h5>
        </div>
            ...
            <div class="bg-light rounded h-100 p-4">
                    ...
                    <div class="col-xl-10">
                        <div class="row">
                            <div class="col-sm-12 col-xl-3">
                                <p>รหัส : <?php echo $Import_ID; ?></p>
                            </div>

                            <div class="col-sm-12 col-xl-1"></div>

                            <div class="col-sm-12 col-xl-8" style="text-align: right;">
                                <p>สายพันธุ์ : <?php echo $Breed_Name; ?></p>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-sm-12 col-xl-8">
                                <p>จำนวน : <?php echo $Import_Amount; ?> ตัว</p>
                            </div>

                            <div class="col-sm-12 col-xl-4" style="text-align: right;">
                                <p>วันที่นำเข้า : <?php echo $Import_Date; ?></p>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-sm-12 col-xl-8">
                                <p>รายละเอียด : <?php echo $Import_Details; ?></p>
                            </div>

                            <div class="col-sm-12 col-xl-4" style="text-align: right;">
                                <p>วันที่บันทึก : <?php echo $Import_Date_Record; ?></p>
                            </div>
                        </div>
                    </div>

                    <div class="col-sm-12 col-xl-2">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#EditImportModal<?= $Import_ID; ?>"
                                style="height:auto; width: 100%;">แก้ไข
                        </button>
                        ...
                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" onclick="UserID(<?= $User_ID; ?>)"
                                data-bs-target="#confirmDeleteModal" style="height:auto; width: 100%;">ลบ
                        </button>
                ...
                ?>
                    <div class="row" style="margin-bottom: 5px;">
                        ...
                        <div class="col-sm-2 col-xl-2">
                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#addRecordModal" 
                                    style="height: 40px; width: 60%; position: relative; left: 35%; font-size: 13px;">เพิ่มข้อมูล
                            </button>
                        </div>
                    </div>
