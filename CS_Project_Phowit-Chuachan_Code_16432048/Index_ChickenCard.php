<div class="container-fluid pt-3 px-3">
    ...
    <div class="row">
        ...
        ?>
            <div class="col-sm-3 col-xl-3" style="margin-bottom : 5px;">
                <div class="bg-light rounded h-100 p-3">
                    <div class="row">
                        <h6 class="mb-4"><?php echo $Breed_Name; ?></h6>
                        <div class="col-sm-12 col-xl-12 text-center">
                            <?php echo "<img src='data:image/jpeg;base64,$base64Image' alt='Breed_Img' style='width: auto; height: 100px; border-radius: 5px;'>"; ?>
                        </div>
