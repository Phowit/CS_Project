...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-dark navbar-primary">
        ...
        <div class="navbar-nav w-100">
            ...
            <a href="Admin_Status.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2 icon"></i>จัดการข้อมูลสถานะ</a>
            <a href="Admin_ManageGeneChicken.php" class="nav-item nav-link text-light"><i class="far fa-file-alt me-2 icon"></i>จัดการข้อมูลพันธุ์ไก่</a>
