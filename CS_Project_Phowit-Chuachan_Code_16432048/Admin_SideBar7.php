    ...
    <nav class="navbar bg-dark navbar-primary">
        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                <a class="nav-link dropdown-toggle text-light active" data-bs-toggle="dropdown"><i class="fa fa-table me-2 icon"></i>จัดการข้อมูลไก่</a>
                <div class="dropdown-menu bg-transparent border-0">
                    <a href="Admin_ManageImport.php" class="dropdown-item text-dark active">จัดการข้อมูลนำเข้าไก่</a>
