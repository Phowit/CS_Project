    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <h5>ข้อมูลฟาร์มเกษตร มหาวิทยาลัยราชภัฏพระนครศรีอยุธยา</h5>
                <div class="row vh-100 bg-secondary rounded align-items-center justify-content-center mx-0" style="background-color: rgba(255, 255, 255, 0.5);">
                    ...
                    <div class="col-md-6 col-sm-12 col-xl-6 bg-primary rounded">
